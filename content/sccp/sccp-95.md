...
The current `maxDebt` was configured to be sUSD 75 million in [ECCP-94](https://eips.elysian.finance/ECCP/eccp-94) but has almost been reached, this eccp proposes to increase it to sUSD 90 million given the increased demand for shorts.
