  ...
  return (
    <main>
      ...
      <script
        dangerouslySetInnerHTML={{
          __html: `
            ...
            (function() {
              var u="https://analytics.elysian.finance/";
        ...
        <div className="wrapper">
          ...
          <nav className="site-nav">
            ...
            <div className="trigger">
              <a className="page-link" href="/all-eip">
                All EIPs
              </a>
              <a className="page-link" href="/all-eccp">
                All ECCPs
              </a>
            </div>
          </nav>
      ...
      <footer className="site-footer h-card">
        <div className="wrapper">
          <h2 className="footer-heading">EIPs</h2>

          <div className="footer-col-wrapper">
            <div className="footer-col footer-col-1">
              <ul className="contact-list">
                <li className="p-name">EIPs</li>
              </ul>
            </div>
            ...
            <div className="footer-col footer-col-3">
              <p>
                Elysian Improvement Proposals (EIPs) describe standards for
                the Elysian platform, including core protocol specifications,
